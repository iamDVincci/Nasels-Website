          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="p-1 rounded-full bg-[#FAF7EE] border border-[#F0EAD6] text-[#0E5C36] shrink-0">
                  {isOpen ? <Minus className="w-4 h-4" /> : <Plus className="w-4 h-4" />}
                </span>
              </button>

              {isOpen && (
                <div className="px-5 sm:px-6 pb-6 text-xs sm:text-sm text-[#525D56] leading-relaxed font-sans border-t border-[#F0EAD6]/50 pt-3 animate-in fade-in duration-150">
                  {faq.a}
                </div>
              )}
            </div>
